...
alter table sinsang change column sex gender varchar(2) default '여자';
...
update sinsang set point = 50 + point where gender = '남자' and age >= 35;
...
update sinsang set pwd = '0000', point = 300 + point where address = '서울';
